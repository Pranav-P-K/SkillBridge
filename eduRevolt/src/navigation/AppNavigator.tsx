...
import SkillSwapScreen from '../screens/SkillSwapScreen';
import ProblemPodsScreen from '../screens/ProblemPodsScreen';
import OpportunityBoardScreen from '../screens/OpportunityBoardScreen';
...
function DrawerRoot() {
  return (
    ...
    >
      ...
      <Drawer.Screen 
        name="SkillSwap" 
        component={SkillSwapScreen} 
        options={{
          drawerIcon: ({color}) => <Ionicons name="swap-horizontal-outline" size={22} color={color} />
        }} 
      />
      <Drawer.Screen 
        name="Problem Pods" 
        component={ProblemPodsScreen} 
        options={{
      ...
      <Drawer.Screen 
        name="Opportunities" 
        component={OpportunityBoardScreen} 
        options={{
