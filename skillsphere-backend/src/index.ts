...
import skillSwapRoutes from "./routes/skillSwap";
import problemPodsRoutes from "./routes/problemPods";
import opportunitiesRoutes from "./routes/opportunities";
import generateLessonsRoutes from "./routes/generateLessons";
...
app.route("/generate-lessons", generateLessonsRoutes);
app.route("/roadmap", roadmapRoutes);
app.route("/simulations", simulationsRoutes);
app.route("/skillswap", skillSwapRoutes);
app.route("/pods", problemPodsRoutes);
